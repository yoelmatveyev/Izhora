...
A variety of Fireworld, called FireWorld, was introduced in February 2022. Its wire interaction rules match the "2ak" element of the original Fireworld. The almost identical name was chosen to match the name of the well known rule WireWorld and because FireWorld is meant to supersede the original 2001 rule. 
